...
class person{
   ...
   function  CheckLoginInDB($username,$password){
        $query = "Select * from flight_sys.users 
		left join flight_sys.image on image.id=users.Image_id
		left join flight_sys.country on country.id=users.Country_id
