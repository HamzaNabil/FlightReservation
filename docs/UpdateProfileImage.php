...
$(document).ready(function() { 
	...
	var options = { 
			target:   '#output', 
			data:{table:$('#table').val(), id:$('#id').val()},  // target element(s) to be updated with server response 
...
<link href="css/imguploder.css" rel="stylesheet" type="text/css">
</head>
<body>
...
<input type="text" style="display:none;"  id="table" value="users" />
