	...
	if (isset($_POST['submit'])) {
			if (!empty($_POST['Adress'])) {
				if ($_SESSION['userid']==$_POST['userID']){
					if($user->UpdateAdress($_POST['userID'],$_POST['Adress'],$_POST['oldPass']))
...
<div class="w3-container w3-green">
  <h2>Change Passwordt</h2>
		...
		* Update Adress : 	<input  class="w3-input w3-border w3-round-large" type="text" name="Adress" required><br/>
